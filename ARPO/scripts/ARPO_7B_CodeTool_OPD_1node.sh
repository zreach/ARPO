...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-opd_7b_code_tool_only}"

# Keep the earlier lightweight OPD branch disabled; this script uses the
# my-verl-style teacher-logprob distillation branch below.
